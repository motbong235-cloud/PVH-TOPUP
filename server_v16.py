...
Serves:
  GET /       -> index_v6.html (single-file frontend)
...
STATIC_DIR = BASE_DIR  # index_v6.html + admin_v5.html live alongside this file
...
if SITE_PRIVATE:
    ...
    def _require_site_login():
        ...
        if not ok:
            ...
            resp.headers["WWW-Authenticate"] = 'Basic realm="PVH TOPUP (private)"'
            return resp
        return None
...
def serve_admin():
    ...
    try:
        ...
        # admin_v5.html wasn't part of this deploy bundle — every /api/admin-*
